...
function wppm_project_shortcode()
{
  ...
  <div class="row justify-content-center">
    <div class="col-md-5 col-12 mb-3">
      ...
      <select id="project-category" name="project_category[]" multiple class="select2" style="width: 100%;" placeholder="Select Project Categories">
    ...
    <div class="col-md-5 col-12 mb-3">
      ...
      <select id="project-keywords" name="keywords[]" multiple class="select2" style="width: 100%;" placeholder="Select Keywords">
        <option value="">Select Keyword(s)</option>
        <?php
